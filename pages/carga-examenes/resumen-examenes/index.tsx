...
import { SET_DATAS_SELEC_COURSES_TEACHER_CE, SET_TEACHERCODE } from "../../../consts/storageConst";
...
const index = () => {
    ...
    const LoadedExamsApi = async () => {
        ...
        const result: any = await apiCargaExamenes.listLoadedExams(UserID,DataSelect.ClaCodigo)
        return result
    }
                ...
                >
                 <Tabla classname={styles.tablaRA}>
                    ...
                    <tr>
                        ...
                        <td>{DataSelect !== undefined ? DataCoursesByTeacher?.SemCodigo : ""}</td>
                    </tr>
                    <tr>
                        <td style={{ fontWeight: 'bold' }}>Sede</td>
                        <td>{DataSelect !== undefined ? DataCoursesByTeacher?.SedCodigo : ""}</td>

                    </tr>
                    <tr>
                        <td style={{ fontWeight: 'bold' }}>Carrera</td>
                        <td>{DataSelect !== undefined ? DataCoursesByTeacher?.CarNombre : ""}</td>

                    </tr>
                    <tr>
                        <td style={{ fontWeight: 'bold' }}>Cóigo del curso</td>
                        <td>{DataSelect !== undefined ? DataCoursesByTeacher?.CurCodigo : ""}</td>

                    </tr>
                    <tr>
                        <td style={{ fontWeight: 'bold' }}>Nombre del curso</td>
                        <td>{DataSelect !== undefined ? DataCoursesByTeacher?.CurNombre : ""}</td>

                    </tr>
                    <tr>
                        <td style={{ fontWeight: 'bold' }}>Clase</td>
                        <td>{DataSelect !== undefined ? DataCoursesByTeacher?.ClaCodigo : ""}</td>

                    </tr>
                    <tr>
                        <td style={{ fontWeight: 'bold' }}>Tope faltas</td>
                        <td>{DataSelect !== undefined ? DataCoursesByTeacher?.ClaTopeFaltas : ""}</td>
