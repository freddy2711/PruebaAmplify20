...
const API = {
    ...
    listClassDate: async (classCode:string,teacherCode:string,action:string) => {
    ...
    ScheduleSessions: async (action:string,classCode:string,semesterCode:string,date:string,teacherCode:string) => {
        const obj = {
            action,classCode,semesterCode,date,teacherCode
        }
    ...
    ClasEnabled: async (classCode:string,sedeCode:string,date:string,hours:string,quantity:string) => {
        const URL = `/recuperar-adelantar/ClasEnabled/${classCode}/${sedeCode}/${date}/${hours}/${quantity}`
        const result:any = await axiosfetchPublic(URL)
        return result.data
    },
    AttendanceRecoverys: async (classCode:any,teacherCode:any,classDate:any,dateRequired:any,codeHour:any,nroHours:any,classRoomCode:any,user:any,host:any,hourIdProgInitial:any,hourIdProgFinal:any,type:any,path:any) => {
        const obj = {
                classCode,
                teacherCode,
                classDate,
    ...
    AttendanceRecoverysPUT: async (recoveryId:any,classDate:any,dateRequired:any,codeHour:any,nroHours:any,classRoomCode:any,user:any,host:any,type:any,path:any) => {
        const obj = {
                recoveryId,
                classDate,
                dateRequired,
