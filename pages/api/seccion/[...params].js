...
var handler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var params, _a, URL_1, data, result, error_1, Request_1, URL_2, data, result, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [3 /*break*/, 11];
            case 1:
                URL_1 = path_1.apiPath.home.PATH_PostTeacherAttendance(params[1]);
            ...
            case 6:
                Request_1 = req.body;
                URL_2 = path_1.apiPath.home.PATH_PostSeccionOpen;
                _b.label = 7;
            case 7:
                _b.trys.push([7, 9, , 10]);
