...
const handler = async (req: NextApiRequest, res: NextApiResponse<Data>) => {
    ...
    switch (params[0]) {
        ...
        case 'listClassAttendance':
          try {
              const URL = apiPath.reportesAcademicos.PATH_GetClassAttendance(params[1])
              const { data } = await axiosfetchPrivate(URL)
              const result = data.detail
              res.status(200).json(result)
            } catch (error) {
        ...
        case 'listCompetenceGeneralByClass':
          try {
              const URL = apiPath.reportesAcademicos.PATH_GetCompetenceGeneralByClass(params[1])
              const { data } = await axiosfetchPrivate(URL)
              const result = data.detail
              res.status(200).json(result)
            } catch (error) {
        ...
        case 'listCompetenceSchedule':
          try {
              const URL = apiPath.reportesAcademicos.PATH_GetCompetenceSchedule(params[1],params[2])
              const { data } = await axiosfetchPrivate(URL)
              const result = data.detail
              res.status(200).json(result)
            } catch (error) {
        ...
        case 'listDetailClass':
          try {
              const URL = apiPath.reportesAcademicos.PATH_GetDetailClass(params[1],params[2])
              const { data } = await axiosfetchPrivate(URL)
              const result = data.detail
              res.status(200).json(result)
            } catch (error) {
