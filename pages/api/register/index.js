...
var API = {
    ByControl: function (obj) { return __awaiter(void 0, void 0, void 0, function () {
        var URL_1, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    URL_1 = "/register/control/".concat(obj.code, "/").concat(obj.time);
    ...
    AttendanceSummary: function (classCode) { return __awaiter(void 0, void 0, void 0, function () {
        var URL_2, result, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    URL_2 = "/register/summary/".concat(classCode);
