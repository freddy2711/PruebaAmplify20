...
const ReporteEstadisticas = () => {
    ...
    const COLUMNS = [
        ...
        { label: '% Habil.', field: 'PorcEnabled', key: 'PorcEnabled', sort: 'asc' },
        { label: 'Inhab.', field: 'Disabled', key: 'Disabled', sort: 'asc' },
        { label: '% Inhab.', field: 'PorcDisabled', key: 'PorcDisabled', sort: 'asc' },
        ...
        { label: 'Nota Prom.', field: 'AvgAverage', key: 'AvgAverage', sort: 'asc' },
        { label: 'Nota Desv.', field: 'StdevAverage', key: 'StdevAverage', sort: 'asc' },
        { label: 'Aprob.', field: 'Approved', key: 'Approved', sort: 'asc' },
        { label: '% Aprob.', field: 'PorcApproved', key: 'PorcApproved', sort: 'asc' },
        { label: 'Desap.', field: 'Disapproved', key: 'Disapproved', sort: 'asc' },
        { label: '% Desap.', field: 'PorcDisapproved', key: 'PorcDisapproved', sort: 'asc' },
    ]
    ...
    const ApiClassStatistics = async (TraCode:any) => {
        const response = await apiReportesAcademicos.listClassStatistics("%",TraCode,"%","%");
        return response
    }
        ...
        <div>
            <div className={styles.contenido}>
                ...
                <div className={styles.alertaContent}>
                    ...
                    >
                        <p className="mb-0">
                        En el cálculo del promedio general de la clase (Nota Prom.), así como la desviación estándar (Nota Desv.), se incluyen a los alumnos con nota igual a cero.
                        </p>
                    </Alerta>
                </div>
