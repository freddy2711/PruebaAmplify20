...
import {
  loadInfoGeneral	
} from './../../redux/actions/infoGeneralAction'
...
const DatosPersonales = () => {
  ...
  useEffect(() => {
	...
	useEffect(() => { 
		...
		if (Object.keys(progresoData).length !== 0) {
			...
			if(parseInt(progresoData.ValueEvaluation) > 0 && parseInt(progresoData.ValueEvaluation) < 100){
	...
	const confirmHandle = () => {
        ...
        if (avance !== 0 && avance !== 100) {
            ...
            Swal.fire({
                title: "Datos Personales",
                html: "Declaro haber completado y/o validado la información de mis datos personales al día de hoy <b>" + FormatDate(d.toISOString()) + "</b>",
                icon: 'info',
  ...
  return (
    <div className={styles.default}>
			<ModalAvance avance={progress} modalShowAvance={modalShowAvance} setModalShowAvance={setModalShowAvance} />
