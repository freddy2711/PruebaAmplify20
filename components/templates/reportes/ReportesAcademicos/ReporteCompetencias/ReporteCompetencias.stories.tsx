...
import styles from './ReporteCompetencias.module.scss'
...
storiesOf(
  'Templates/reportes/ReportesAcademicos/ReporteCompetencias/ReporteCompetencias',
  module
)
  .addDecorator((Story) => (
